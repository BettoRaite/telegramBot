export const COMMANDS_LIST = `❇️ Список команд:
...
`;
export const INTRODUCTION_TEXT = `こ日は или же 'Привет' на твоём языке 😁
...
`;
export const INVALID_MESSAGE = `😞 К сожалению, я только понимаю определенные команды)

👉 Как насчет, вы мне подарите свой мозг и я наконец-то захвачу этот мир? 😏
        `;
export const INVALID_UPLOAD_DATA = "❌ Брр...данный тип данных пока что не поддерживается ❌";
export const MAIN_MENU_TEXT = "❇️ Список возможных опций";
export const HOMEWORK_UPLOAD_MESSAGE =
  "👉 Вы можете скинуть свое домашнее задание в формате текста 📝, либо картинок 🌠.";
export const UPLOAD_SUCCESS_MESSAGE = "✅ Готово";
export const CANCEL_OPERATION_SUCCESS_MESSAGE = "🚫 Операция была отменена.";
export const FATAL_ERROR_MESSAGE =
  "❌ Возникла неприятная ошибка! Прошу немедленно сообщить её разработчику! 🧐";
export const CANCEL_OPERATION_ERROR_MESSAGE = "😃 Походу тут нечего отменять.";
export const ERROR_DOC_UPLOAD_MESSAGE =
  "К сожалению загрузка документов, на данный момент, не поддерживается. 😕";
export const UPLOAD_LIMIT_REACHED_MESSAGE = "🥲 Достигнут дневной лимит по загрузке информации -";
export const NO_ACTION_CHOOSEN = "😬 А вы знали?... сперва нужно выбрать действие!";
export const UNKNOWN_COMMAND = `😵‍💫 Кажись, вы немного перепутали команды... ✍️ Попробуйте ещё раз.

👉 либо нажмите на /main чтобы вернутся в главное меню`;
export const EXCEEDED_TIME_LIMIT = "Печально, но вы ничего не написали 🫠";
export const NO_DATA_FOUND = "😕 К сожалению тут пока что пусто...";
export const SUBJECTS_MENU_TEXT = "👉 Выберите один из предметов.";
export const ACCESS_RESTRICTED_MESSAGE = "Упс...🤓 У вас нет доступа к сохранению дз. ";
export const SET_TIME_COMMAND_TEXT = `Чтобы настроить расписание звонков для вашей группы
...
// BUTTONS
export const BTN_TEXT_GET_ACTION = "Получить дз";
export const BTN_TEXT_UPLOAD_ACTION = "Сохранить дз";
// BUTTONS END
