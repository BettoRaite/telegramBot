...
if (false) {
  ...
  describe("filterThisWeekdayStudySchedule", () => {
    describe("returns study schedule on the current week day or default one", () => {
      describe("Good cases", () => {
        it("If studySchedules is defined correctly, should return an array", () => {
        ...
        describe(`If studySchedules obj has study schedule on a certain weekday and the current weekday 
        match that weekday should return study schedule on that weekday`, () => {
      ...
      describe("Bad cases", () => {
        it("Should throw type error if studySchedules isn't object", () => {
          ...
          const expectedDescription = `studySchedules was expected to be an object, instead got this ${studySchedules}`;
          assert.throws(
        ...
        it("Should throw type error if localTime isn't an instance of date", () => {
          const localTime = {};

          const expectedDescription = `localTime was expected to be an instance of date, instead got this ${localTime}`;
          assert.throws(
        ...
        it("Throws error if study schedule in study schedules object can't be parsed by JSON.parse", () => {
          const localTime = new Date();
          const studySchedules = {
            default: undefined,
          };
...
if (true) {
  ...
  describe("processTimeInfo", () => {
    describe("processes time info array and create a message for the user", () => {
      context(
        "when calculated difference between user time is not in range of study day interval",
        () => {
